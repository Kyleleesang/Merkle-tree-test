 ...
 *
 */
 function createMerkleTree(fastMap, hashalgo, cb) {
...
function MerkleTreeHeight(cb){
    tree = cb;
    return tree.MerkleTreeHeight;

}

function MerkleTreeRoot(cb){
    tree = cb;
    return tree.MerkleTreeHeight;

}

function MerkleTreeLevel(index, cb){
    return
